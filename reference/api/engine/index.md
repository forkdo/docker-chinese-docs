...
您可以[查看最新版本的 API 参考文档](/reference/api/engine/version/v1.55.md)，或[选择特定版本](/reference/api/engine/#api-version-matrix)。
...
- 直接使用 `curl` 时，请在 URL 的第一部分指定版本。例如，如果端点是 `/containers/`，可以使用 `/v1.55/containers/`。
...
Docker Engine 和 CLI 版本支持。您可以在 [GitHub 代码仓库中](https://github.com/moby/moby/tree/docker-v29.7.2/api/docs) 找到已弃用 API 版本的归档文档：
