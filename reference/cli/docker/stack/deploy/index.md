...
<!--
此页面由 Docker 源代码自动生成。如果您想修改此处显示的文本，请在 GitHub 的源代码仓库中提交工单或拉取请求：
...
| `-d`, `--detach` | `true` |  Exit immediately instead of waiting for the stack services to converge<br> |
| `--prune` |  | API 1.27+ Prune services that are no longer referenced |
| `-q`, `--quiet` |  |  Suppress progress output |
| `--resolve-image` | `always` | API 1.30+ Query the registry to resolve image digest and supported platforms (`always`, `changed`, `never`)<br> |
