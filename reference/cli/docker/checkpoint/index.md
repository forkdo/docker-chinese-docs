...
| Command | Description |
|---------|-------------|
| [`docker checkpoint create`](/reference/cli/docker/checkpoint/create/) | Create a checkpoint from a running container |
| [`docker checkpoint ls`](/reference/cli/docker/checkpoint/ls/) | List checkpoints for a container |
| [`docker checkpoint rm`](/reference/cli/docker/checkpoint/rm/) | Remove a checkpoint |
