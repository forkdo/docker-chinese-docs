# docker desktop (Beta)
  ...
  <a class="link" href="https://docs.docker.com/desktop/release-notes/#4370">4.37</a> and later</span>
        <span class="icon-svg">
...
- [docker desktop 引擎](https://docs.docker.com/reference/cli/docker/desktop/engine/)

- [Docker Desktop 日志](https://docs.docker.com/reference/cli/docker/desktop/logs/)
