...
| Command | Description |
|---------|-------------|
| [`docker manifest annotate`](/reference/cli/docker/manifest/annotate/) | Add additional information to a local image manifest |
| [`docker manifest create`](/reference/cli/docker/manifest/create/) | Create a local manifest list for annotating and pushing to a registry |
| [`docker manifest inspect`](/reference/cli/docker/manifest/inspect/) | Display an image manifest, or manifest list |
| [`docker manifest push`](/reference/cli/docker/manifest/push/) | Push a manifest list to a repository |
| [`docker manifest rm`](/reference/cli/docker/manifest/rm/) | Delete one or more manifest lists from local storage |
