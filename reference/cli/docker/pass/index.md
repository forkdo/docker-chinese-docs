...
| Command | Description |
|---------|-------------|
| [`docker pass get`](/reference/cli/docker/pass/get/) | Get a secret from a keystore. |
| [`docker pass ls`](/reference/cli/docker/pass/ls/) | List all secrets from local keychain. |
| [`docker pass plugins`](/reference/cli/docker/pass/plugins/) | Manage secrets engine plugins. |
| [`docker pass rm`](/reference/cli/docker/pass/rm/) | Remove secrets from local keychain. |
| [`docker pass run`](/reference/cli/docker/pass/run/) | Run a command with `se://` environment references resolved. |
