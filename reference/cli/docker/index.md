...
| `-c`, `--context` |  |  Name of the context to use to connect to the daemon (overrides DOCKER_HOST env var and default context set with `docker context use`)<br> |
...
| [`docker compose`](/reference/cli/docker/compose/) | Docker Compose |
| [`docker config`](/reference/cli/docker/config/) | Manage Swarm configs |
...
| [`docker secret`](/reference/cli/docker/secret/) | Manage Swarm secrets |
| [`docker service`](/reference/cli/docker/service/) | Manage Swarm services |
| [`docker stack`](/reference/cli/docker/stack/) | Manage Swarm stacks |
| [`docker swarm`](/reference/cli/docker/swarm/) | Manage Swarm |
| [`docker system`](/reference/cli/docker/system/) | Manage Docker |
