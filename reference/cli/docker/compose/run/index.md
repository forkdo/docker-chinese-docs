...
| `-P`, `--service-ports` |  |  Run command with all service's ports enabled and mapped to the host<br> |
| `--use-aliases` |  |  Use the service's network useAliases in the network(s) the container connects to<br> |
