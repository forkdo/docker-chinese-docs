...
| [`docker compose ls`](/reference/cli/docker/compose/ls/) | List running compose projects |
| [`docker compose pause`](/reference/cli/docker/compose/pause/) | Pause services |
| [`docker compose port`](/reference/cli/docker/compose/port/) | Print the public port for a port binding |
| [`docker compose ps`](/reference/cli/docker/compose/ps/) | List containers |
| [`docker compose publish`](/reference/cli/docker/compose/publish/) | Publish compose application |
| [`docker compose pull`](/reference/cli/docker/compose/pull/) | Pull service images |
| [`docker compose push`](/reference/cli/docker/compose/push/) | Push service images |
...
| [`docker compose up`](/reference/cli/docker/compose/up/) | Create and start containers |
| [`docker compose version`](/reference/cli/docker/compose/version/) | Show the Docker Compose version information |
| [`docker compose volumes`](/reference/cli/docker/compose/volumes/) | List volumes |
| [`docker compose wait`](/reference/cli/docker/compose/wait/) | Block until containers of all (or specified) services stop. |
| [`docker compose watch`](/reference/cli/docker/compose/watch/) | Watch build context for service and rebuild/refresh containers when files are updated
 |
