...
>
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">增强容器隔离</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解增强容器隔离如何防止容器攻击。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">控制开发者在 Docker Desktop 上可以访问的注册表。</p>
    </div>
    ...
    <a href="/enterprise/security/enforce-sign-in/" class="card-link">
    ...
    <div class="card-content">
      <p class="card-description">为您的团队和组织成员配置登录。</p>
    </div>
    ...
    <a href="/enterprise/security/domain-management/" class="card-link">
    ...
    <div class="card-content">
      <p class="card-description">识别组织内未被覆盖的用户。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">探索 Docker Scout 如何帮助您创建更安全的软件供应链。</p>
    </div>
    ...
    <a href="/enterprise/security/single-sign-on/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">SSO</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解如何为您的公司或组织配置 SSO。</p>
    </div>
    ...
    <a href="/enterprise/security/provisioning/scim/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">SCIM</h3>
    </div>
    <div class="card-content">
      <p class="card-description">设置 SCIM 以自动配置和取消配置用户。</p>
    </div>
    ...
    <a href="/enterprise/security/roles-and-permissions/" class="card-link">
    ...
    <a href="/desktop/extensions/private-marketplace/" class="card-link">
    ...
    <div class="card-header">
      ...
      <div class="card-icon">
          ...
          <span class="card-img svg">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 -960 960 960"><path d="M179-120q-24 0-42-18t-18-42v-339q-28-24-37-59t2-70l43-135q8-27 28-42t46-15h553q28 0 49 15.5t29 41.5l44 135q11 35 1.5 70T840-519v339q0 24-18 42t-42 18H179Zm391-430q29 0 49-19t16-46l-25-165H510v165q0 26 17 45.5t43 19.5Zm-187 0q28 0 47.5-19t19.5-46v-165H350l-25 165q-4 26 14 45.5t44 19.5Zm-182 0q24 0 41.5-16.5T263-607l26-173H189l-46 146q-10 31 8 57.5t50 26.5Zm557 0q32 0 50.5-26t8.5-58l-46-146H671l26 173q3 24 20.5 40.5T758-550Z"/></svg>
          </span>
        
      </div>
      
      <h3 class="card-title">扩展的私有市场（Beta）</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解如何为您的 Docker Desktop 用户配置和设置带有精选扩展列表的私有市场。</p>
    </div>
    ...
    <a href="/enterprise/security/access-tokens/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">组织访问令牌</h3>
    </div>
    <div class="card-content">
      <p class="card-description">创建组织访问令牌作为密码的替代。</p>
    </div>
