...
>
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">什么是加固镜像以及为何要使用它们？</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解什么是加固镜像、Docker Hardened Images 的构建方式、它们与典型基础镜像和应用镜像的区别，以及您应该使用它们的原因。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">了解 Docker 如何通过自动化、以安全为中心的管道来构建、测试和维护 Docker Hardened Images。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">查看 Docker Hardened Images 如何自动进行标准合规性、功能性和安全性测试。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">了解在您将 Docker Hardened Images 作为安全软件供应链的一部分使用时，Docker 的角色和您的责任。</p>
    </div>
