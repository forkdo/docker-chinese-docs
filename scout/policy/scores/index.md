...
>
  ...
  <div>
      ...
      >
        <p>要查看 Docker Hub 中镜像的健康评分：</p>
<ol>
<li>访问 Docker Hub 并登录。</li>
<li>导航到您的组织页面。</li>
</ol>
<p>在仓库列表中，您可以看到每个仓库基于最新推送标签的健康评分。</p>
...
>
  ...
  <template x-teleport="body">
    ...
    >
      ...
      >
        <p>要查看 Docker Desktop 中镜像的健康评分：</p>
<ol>
<li>打开 Docker Desktop 并登录到您的 Docker 账户。</li>
<li>导航到<strong>镜像</strong>视图并选择 <strong>Hub</strong> 选项卡。</li>
</ol>
<p>在仓库列表中，<strong>健康</strong>列显示已推送到 Docker Hub 的不同标签的评分。</p>
