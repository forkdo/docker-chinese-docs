...
Docker 订阅提供 Docker 产品的商业使用许可，包括 Docker Desktop、Docker Hub、Docker Build Cloud、Docker Scout 和 Testcontainers Cloud。

使用这些资源来选择适合您需求的订阅或管理您现有的订阅。
...
>
    ...
    <a href="https://www.docker.com/pricing/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">比较 Docker 订阅</h3>
    </div>
    <div class="card-content">
      <p class="card-description">访问定价页面，查看不同 Docker 订阅包含的内容。</p>
    </div>
    ...
    <a href="/subscription/setup/" class="card-link">
    ...
    <a href="/subscription/scale/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">扩展您的订阅</h3>
    </div>
    <div class="card-content">
      <p class="card-description">根据您的需求扩展订阅规模。</p>
    </div>
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">更改您的订阅</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解如何升级或降级您的订阅。</p>
    </div>
    ...
    <a href="/subscription/manage-seats/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">管理席位</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解如何为您的订阅添加或移除席位。</p>
    </div>
    ...
    <a href="/subscription/desktop-license/" class="card-link">
    ...
    <a href="/subscription/faq/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">订阅常见问题</h3>
    </div>
    <div class="card-content">
      <p class="card-description">找到您需要的答案，探索常见问题。</p>
    </div>
