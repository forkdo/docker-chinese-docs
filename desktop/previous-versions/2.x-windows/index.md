...
<!-- FILE: manuals/desktop/previous-versions/2.x-windows.md -->

---
description: Docker Desktop for Windows 2.x 发布说明
keywords: Docker Desktop for Windows 2.x, 发布说明
...
- 修复了用户无法通过 Docker Desktop UI 修改**手动代理配置**设置的错误。修复 [docker/for```
