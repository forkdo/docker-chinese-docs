...
>
  ...
  <div class="relative w-full">
    ...
    <div class="syntax-light dark:syntax-dark not-prose w-full">
      <button
        x-data="{ code: 'JCBzdWRvIGFwdC1nZXQgaW5zdGFsbCBkb2NrZXItY2UgZG9ja2VyLWNlLWNsaSBjb250YWluZXJkLmlvIGRvY2tlci1idWlsZHgtcGx1Z2luIGRvY2tlci1jb21wb3NlLXBsdWdpbg==', copying: false }"
        class="
          top-1
      ...
      >
        ...
        <div class="highlight"><pre tabindex="0" class="chroma"><code class="language-console" data-lang="console"><span class="line"><span class="cl"><span class="gp">$</span> sudo apt-get install docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin
...
>
  ...
  <div class="relative w-full">
    ...
    <div class="syntax-light dark:syntax-dark not-prose w-full">
      <button
        x-data="{ code: 'IyDliJflh7rlj6/nlKjniYjmnKzvvJoKJCBhcHQtY2FjaGUgbWFkaXNvbiBkb2NrZXItY2UgfCBhd2sgJ3sgcHJpbnQgJDMgfScKCjU6MjkuMS4zLTF&#43;cmFzcGJpYW4uMTJ&#43;Ym9va3dvcm0KNToyOS4xLjItMX5yYXNwYmlhbi4xMn5ib29rd29ybQouLi4=', copying: false }"
        class="
          top-1
         absolute right-2 z-10 text-gray-300 dark:text-gray-500"
        title="copy"
...
>
  ...
  <div class="relative w-full">
    ...
    <div class="syntax-light dark:syntax-dark not-prose w-full">
      <button
        x-data="{ code: 'JCBWRVJTSU9OX1NUUklORz01OjI5LjEuMy0xfnJhc3BiaWFuLjEyfmJvb2t3b3JtCiQgc3VkbyBhcHQtZ2V0IGluc3RhbGwgZG9ja2VyLWNlPSRWRVJTSU9OX1NUUklORyBkb2NrZXItY2UtY2xpPSRWRVJTSU9OX1NUUklORyBjb250YWluZXJkLmlvIGRvY2tlci1idWlsZHgtcGx1Z2luIGRvY2tlci1jb21wb3NlLXBsdWdpbg==', copying: false }"
        class="
          top-1
         absolute right-2 z-10 text-gray-300 dark:text-gray-500"
        title="copy"
      ...
      >
        ...
        <div class="highlight"><pre tabindex="0" class="chroma"><code class="language-console" data-lang="console"><span class="line"><span class="cl"><span class="gp">$</span> <span class="nv">VERSION_STRING</span><span class="o">=</span>5:29.1.3-1~raspbian.12~bookworm
...
1. 转到 [`https://download.docker.com/linux/raspbian/dists/`](https://download.docker.com/linux/raspbian/dists/)。
