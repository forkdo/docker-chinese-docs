...
>
  <div aria-role="tablist" class="tablist">
      ...
      <button
        class="tab-item"
        :class="selected === 'Specific-version' &&
          'border-blue border-b-4 dark:border-b-blue-600'"
        
          @click="selected = 'Specific-version'"
...
>
  ...
  <div class="relative w-full">
    ...
    <div class="syntax-light dark:syntax-dark not-prose w-full">
      ...
      <div
        aria-role="tab"
        :class="selected !== 'Specific-version' && 'hidden'"
      >
        <p>要安装特定版本的 Docker Engine，请先列出仓库中
可用的版本：</p>
<div
  data-pagefind-ignore
  x-data
...
>
  ...
  <div class="relative w-full">
    ...
    <div class="syntax-light dark:syntax-dark not-prose w-full">
      <button
        x-data="{ code: 'JCBhcHQgbGlzdCAtLWFsbC12ZXJzaW9ucyBkb2NrZXItY2UKCmRvY2tlci1jZS9ub2JsZSA1OjI5LjEuMy0xfnVidW50dS4yNC4wNH5ub2JsZSA8YXJjaD4KZG9ja2VyLWNlL25vYmxlIDU6MjkuMS4yLTF&#43;dWJ1bnR1LjI0LjA0fm5vYmxlIDxhcmNoPgouLi4=', copying: false }"
        class="
          top-1
         absolute right-2 z-10 text-gray-300 dark:text-gray-500"
        title="copy"
...
</span></span></span><span class="line"><span class="cl"><span class="err"></span><span class="go">docker-ce/noble 5:29.1.3-1~ubuntu.24.04~noble &lt;arch&gt;
</span></span></span><span class="line"><span class="cl"><span class="go">docker-ce/noble 5:29.1.2-1~ubuntu.24.04~noble &lt;arch&gt;
...
>
  ...
  <div class="relative w-full">
    ...
    <div class="syntax-light dark:syntax-dark not-prose w-full">
      <button
        x-data="{ code: 'JCBWRVJTSU9OX1NUUklORz01OjI5LjEuMy0xfnVidW50dS4yNC4wNH5ub2JsZQokIHN1ZG8gYXB0IGluc3RhbGwgZG9ja2VyLWNlPSRWRVJTSU9OX1NUUklORyBkb2NrZXItY2UtY2xpPSRWRVJTSU9OX1NUUklORyBjb250YWluZXJkLmlvIGRvY2tlci1idWlsZHgtcGx1Z2luIGRvY2tlci1jb21wb3NlLXBsdWdpbg==', copying: false }"
        class="
          top-1
         absolute right-2 z-10 text-gray-300 dark:text-gray-500"
        title="copy"
      ...
      >
        ...
        <div class="highlight"><pre tabindex="0" class="chroma"><code class="language-console" data-lang="console"><span class="line"><span class="cl"><span class="gp">$</span> <span class="nv">VERSION_STRING</span><span class="o">=</span>5:29.1.3-1~ubuntu.24.04~noble
