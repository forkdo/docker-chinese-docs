...
>
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">Compose 的工作原理</h3>
    </div>
    <div class="card-content">
    ...
    <div class="card-content">
      <p class="card-description">按照说明安装 Docker Compose。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">在构建一个简单的 Python Web 应用程序时，学习 Docker Compose 的关键概念。</p>
    </div>
    ...
    <a href="/compose/release-notes" class="card-link">
    ...
    <div class="card-content">
      <p class="card-description">了解最新的增强功能和错误修复。</p>
    </div>
    ...
    <div class="card-content">
      <p class="card-description">查找有关为 Docker 应用程序定义服务、网络和卷的信息。</p>
    </div>
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">浏览常见 FAQ</h3>
    </div>
    <div class="card-content">
      <p class="card-description">探索一般 FAQ 并了解如何提供反馈。</p>
    </div>
    ...
    <a href="/compose/releases/migrate/" class="card-link">
    ...
    <div class="card-header">
      ...
      <h3 class="card-title">迁移到 Compose v2</h3>
    </div>
    <div class="card-content">
      <p class="card-description">了解如何从 Compose v1 迁移到 v2</p>
    </div>
