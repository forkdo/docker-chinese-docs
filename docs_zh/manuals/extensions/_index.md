...
您可以将您喜爱的开发工具无缝连接到您的应用程序开发和部署工作流中。通过调试、测试、安全和网络功能来增强 Docker Desktop，并使用扩展 [SDK](extensions-sdk/_index.md) 创建自定义附加组件。

任何人都可以使用 Docker 扩展，并且您可以安装的扩展数量没有限制。

![扩展市场](/assets/images/extensions.webp)
