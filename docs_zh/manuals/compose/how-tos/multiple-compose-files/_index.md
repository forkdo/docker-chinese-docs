<!-- FILE: manuals/compose/how-tos/multiple-compose-files/_index.md -->
...
处理多个 Compose 文件最简单的方法是使用 `-f` 标志来[合并](merge.md)它们。这对于简单的覆盖很有效，但随着配置的增长，[合并规则](merge.md#merging-rules) 可能会使管理变得复杂。
