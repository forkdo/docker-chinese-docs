...
## 我可以将订阅从一个用户或组织账户转移到另一个账户吗？

订阅不能在账户或组织之间转让。

## 我可以暂停或延迟我的 Docker 订阅吗？

您不能暂停或延迟订阅，但可以降级您的订阅。如果订阅账单未在到期日之前支付，将从到期日起享有 15 天的宽限期。

## Docker 提供学术价格吗？

请联系 [Docker 销售团队](https://www.docker.com/company/contact) 了解学术价格选项的信息。

## 我如何为 Docker 内容做贡献？

Docker 提供两种内容贡献计划：

- [Docker 赞助开源计划 (DSOS)](../docker-hub/repos/manage/trusted-content/dsos-program.md)，面向开源项目
