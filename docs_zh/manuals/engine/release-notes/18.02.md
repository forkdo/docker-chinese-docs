...
+ 在 compose 文件中新增版本 3.6 [docker/cli#808](https://github.com/docker/cli/pull/808)
- 修复 `docker ps` 中过滤器的问题，`health=starting` 返回空结果 [moby/moby#35940](https://github.com/moby/moby/pull/35940)
+ 改进已发布端口范围的显示 [docker/cli#581](https://github.com/docker/cli/pull/581)
* 升级 Go 到 1.9.3 [docker/cli#827](https://github.com/docker/cli/pull/827)
- 修复 Kubernetes 堆栈标志中断的问题 [docker/cli#831](https://github.com/docker/cli/pull/831)
...
+ LCOW：合并守护进程存储，允许 LCOW 和 WCOW 双模式 [moby/moby#34859](https://github.com/moby/moby/pull/34859)
- LCOW：修复 OpenFile 参数 [moby/moby#36043](https://github.com/moby/moby/pull/36043)
* LCOW：提高最低要求到 Windows RS3 RTM 版本（16299） [moby/moby#36065](https://github.com/moby/moby/pull/36065)

### 日志

* 改进守护进程配置重载；记录活动配置 [moby/moby#36019](https://github.com/moby/moby/pull/36019)
...
* 禁用发布网络上的服务，实现滚动升级时的零停机部署 [moby/moby#35960](https://github.com/moby/moby/pull/35960)
- 修复如果多个网络在不同空间中具有相同名称时服务无法启动的问题 [moby/moby#30897](https://github.com/moby/moby/pull/30897)
- 修复 `docker service update --network-add` 添加重复网络的问题 [docker/cli#780](https://github.com/docker/cli/pull/780)
- 修复从 17.09 升级到 17.12 时的入口网络问题 [moby/moby#36003](https://github.com/moby/moby/pull/36003)
...
- 修复基于管道错误导致 Docker 守护进程意外关闭的问题 [moby/moby#35968](https://github.com/moby/moby/pull/35968)
- 修复 Win32 中一些 hcsshim::ImportLayer 失败（系统找不到指定的路径）的情况 [moby/moby#35924](https://github.com/moby/moby/pull/35924)
...
* 将 API 升级到版本 1.36 [moby/moby#35744](https://github.com/moby/moby/pull/35744)
...
+ 保护守护进程免受缓慢或死锁的卷插件影响 [moby/moby#35441](https://github.com/moby/moby/pull/35441)
- 修复 `DOCKER_RAMDISK` 环境变量未被遵守的问题 [moby/moby#35957](https://github.com/moby/moby/pull/35957)
* 升级 containerd 到 1.0.1 (9b55aab90508bd389d7654c4baf173a981477d55) [moby/moby#35986](https://github.com/moby/moby/pull/35986)
