...
在 Docker Hub 的 **Manage** 屏幕上，您可以管理组织中已镜像的 Docker Hardened Image (DHI) 仓库、已镜像的 DHI chart 仓库以及自定义项。

## 管理已镜像的 Docker Hardened Image 仓库
...
6.  在您要管理的仓库的最右侧列中，选择菜单图标。

   在这里，您可以：

   - **Customize**：基于源仓库创建自定义镜像。
   - **Stop mirroring**：停止镜像 DHI 仓库。
