...
> [!NOTE]
>
> 如需批量迁移、多架构镜像或脚本化工作流，请参阅[批量迁移 Docker 镜像](/manuals/docker-hub/repos/manage/hub-images/bulk-migrate.md)。
...
2. 使用您原来的 Docker 账户登录 [Docker](https://app.docker.com/login)。
3. 拉取您的镜像：
...
1. 导航至 [Docker Hub](https://hub.docker.com) 并选择 **My Hub**。
2. 选择相应的组织，并验证您的用户账户是否为组织成员。
3. 使用您原来的 Docker 账户登录 [Docker Hub](https://hub.docker.com)，并拉取您的镜像：
