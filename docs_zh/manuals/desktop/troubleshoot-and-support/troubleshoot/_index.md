...
- 选择 Docker 菜单 Docker 菜单 {{< inline-image src="../../images/whale-x.svg" alt="whale menu" >}}，然后选择 **故障排查**。
...
1. 解压文件。在 PowerShell 中，将诊断文件的路径复制并粘贴到以下命令中，然后运行它。它应该类似于以下示例：
...
要在命令行中查看 Docker Desktop 日志的实时流，请从您首选的 shell 运行以下脚本。
