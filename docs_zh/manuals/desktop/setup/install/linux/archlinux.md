...
> **Docker Desktop 使用条款**
>
> 在大型企业（超过 250 名员工或年收入超过 1000 万美元）中商业使用 Docker Desktop 需要 [付费订阅](https://www.docker.com/pricing?ref=Docs&refAction=DocsDesktopArchlinuxInstall)。
...
- 探索 [Docker 的订阅计划](https://www.docker.com/pricing?ref=Docs&refAction=DocsDesktopArchlinuxInstall)，了解 Docker 能为您提供什么。
