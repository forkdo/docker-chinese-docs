...
summary: '本指南介绍如何使用 Docker 容器化 C++ 应用程序。
...
> **致谢**
>
> Docker 衷心感谢 [Pradumna Saraf](https://twitter.com/pradumna_saraf) 和 [Mohammad-Ali A'râbi](https://twitter.com/MohammadAliEN) 对本指南的贡献。
