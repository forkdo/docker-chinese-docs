...
完成本指南的所有先前部分，从[容器化 R 应用程序](containerize.md)开始。您必须拥有一个 [GitHub](https://github.com/signup) 账户和一个 [Docker](https://hub.docker.com/signup) 账户才能完成本部分。
...
6. 在您机器上的本地仓库中，运行以下命令将 origin 更改为您刚刚创建的仓库。确保将 `your-username` 更改为您 GitHub 的用户名，并将 `your-repository` 更改为您创建的仓库的名称。
...
在本部分中，您学习了如何为您的 R 应用程序设置 GitHub Actions 工作流。
