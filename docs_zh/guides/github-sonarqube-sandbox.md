---
title: 如何基于 SonarQube 和 E2B 构建 AI 驱动的代码质量工作流
linkTitle: AI 驱动的代码质量
summary: 使用 E2B 沙箱与 Docker 的 MCP 目录，构建 AI 驱动的代码质量工作流，自动化 GitHub 与 SonarQube 集成。
description: 学习如何创建带有 MCP 服务器的 E2B 沙箱、使用 SonarQube 分析代码质量，并通过与 Claude 的自然语言交互生成带质量门禁的拉取请求。
