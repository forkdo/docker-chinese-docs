---
title: 在 GenAI 中利用 RAG 教会模型新知识
linkTitle: 在 GenAI 中利用 RAG
description:  本指南将带你了解如何搭建并使用集成了检索增强生成（RAG）系统与图数据库的 GenAI 技术栈。学习如何将 Neo4j 等图数据库与 AI 模型集成，以获得更准确、更具上下文感知能力的回答。
keywords: Docker, GenAI, Retrieval-Augmented Generation, RAG, Graph Databases, Neo4j, AI, LLM
summary: |
  本指南讲解如何搭建结合检索增强生成（RAG）与 Neo4j 的 GenAI 技术栈，涵盖关键概念、部署步骤以及一个案例研究，同时提供利用实时数据优化 AI 性能的排障建议。
params:
  tags: [ai]
  time: 35 minutes
---
