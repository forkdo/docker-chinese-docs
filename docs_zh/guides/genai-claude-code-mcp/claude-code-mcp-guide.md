...
1. [创建一个只读的个人访问令牌](/security/access-tokens/#create-a-personal-access-token)，并在 **Secrets** 下输入您的访问令牌
1. 保存配置
...
- **[阅读 MCP 恐怖故事系列](https://www.docker.com/blog/mcp-horror-stories-the-supply-chain-attack/)：** 了解常见的 MCP 安全陷阱以及如何避免它们