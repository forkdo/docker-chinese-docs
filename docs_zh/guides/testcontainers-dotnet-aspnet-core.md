---
title: 使用 Testcontainers 测试 ASP.NET Core Web 应用
linkTitle: ASP.NET Core testing
description: 学习如何使用 Testcontainers for .NET，在 ASP.NET Core 集成测试中以真实的 Microsoft SQL Server 替换 SQLite。
keywords: testcontainers, dotnet, csharp, testing, mssql, asp.net core, integration testing, entity framework
summary: |
  学习如何使用 Testcontainers for .NET 测试 ASP.NET Core Web 应用，
  使用真实的 Microsoft SQL Server 实例而非 SQLite。
aliases:
