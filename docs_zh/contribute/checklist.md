...
使用此清单，以清晰、有帮助且与 Docker Docs 其他部分保持一致的方式进行沟通。
...
使用主动语态的句子更容易阅读。主动语态明确了谁做了什么以及对谁做的。此外，主动语态使句子更直接、更简洁。

助动词如 is、was 或 would 可能表明你正在使用被动语态。而且，如果你能在动词后加上 "by zombies"（被僵尸）这个短语，那么你就是在使用被动语态。
...
写简短、简洁的句子。简练的句子阅读更快，更容易理解。

##### 使用小标题和项目符号列表来分割页面

这有助于快速轻松地找到所需信息。

更多信息，请参阅 [格式化](style/formatting.md#headings-and-subheadings) 页面，或参阅 [组件](components/lists.md) 页面查看示例。
...
在 GitHub 仓库内链接到其他页面或图片时，使用相对链接。

更多信息，请参阅 [格式化](style/formatting.md#links) 页面，或参阅 [组件](components/links.md) 页面查看示例。
...
有关我们风格指南的更深入信息，请探索 [语法](style/grammar.md) 或 [格式化](style/formatting.md) 指南。